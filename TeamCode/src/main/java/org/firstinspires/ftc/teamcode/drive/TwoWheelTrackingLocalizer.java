...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 8192; // through bore encoder
    public static double WHEEL_RADIUS = 1.3; // in // ~~~
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double PARALLEL_X = 3.15; // X is the up and down direction
    public static double PARALLEL_Y = 3.7; // Y is the strafe direction

    public static double PERPENDICULAR_X = -3.15;
    ...
    @Override    public Double getHeadingVelocity() {
